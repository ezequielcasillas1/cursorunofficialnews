...
`mobile/server/src/sources/registry.js` → `ingest/` → `normalize/news-item.js` → `store/` → `index.js` → `mobile/` or `web/` → tap opens original URL
...
- **Key files:** `mobile/server/src/sources/registry.js`, `mobile/server/src/ingest/feeds.js`, `mobile/server/src/index.js`, `mobile/src/screens/FeedScreen.js`, `mobile/src/api/newsClient.js`
...
- **Key files:** `mobile/server/src/normalize/news-item.js`, `mobile/server/src/store/memory-cache.js`, `mobile/server/src/sources/registry.js`, `mobile/src/screens/AboutScreen.js`, `mobile/src/components/NewsListItem.js`
...
- **Key files:** `mobile/server/src/ingest/scrape.js`, `mobile/server/src/sources/registry.js`, `docs/SOURCE-STRATEGY.md`
...
- **Key files:** `mobile/server/src/jobs/` (new), device token endpoint, Expo push or web push via `web/`
...
- **Key files:** deploy `mobile/server/` + EAS/`web/` build; env `API_BASE`; PWA manifest; legal pages
