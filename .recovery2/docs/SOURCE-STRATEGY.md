...
| Source | URL | Method |
|---|---|---|
| Changelog RSS | `https://cursor.com/rss.xml` | RSS |
| Changelog page | `https://cursor.com/changelog` | RSS primary |
| GitHub releases | `https://github.com/getcursor/cursor/releases.atom` | Atom |
| Blog | `https://cursor.com/blog` | RSS (verify; forum reports blog RSS stale) |
...
| Forum | `forum.cursor.com` | Link-out; check Discourse RSS/API |
