export const SOURCES = [
  ...
  {
    id: 'forum-cursor-feature-requests',
    name: 'Cursor Forum — Feature Requests',
    category: 'forum',
    feedUrl: 'https://forum.cursor.com/c/feature-requests/5.rss',
    ingestMethod: 'rss',
    enabled: true,
    priority: 15,
    isOfficial: false,
  ...
  {
    id: 'forum-cursor-bug-report',
    name: 'Cursor Forum — Bug Reports',
    category: 'forum',
    feedUrl: 'https://forum.cursor.com/c/bug-report/6.rss',
    ingestMethod: 'rss',
    enabled: true,
    priority: 16,
    isOfficial: false,
  ...
  {
    id: 'forum-cursor-showcase',
    name: 'Cursor Forum — Showcase',
    category: 'forum',
    feedUrl: 'https://forum.cursor.com/c/showcase/7.rss',
    ingestMethod: 'rss',
    enabled: true,
    priority: 17,
    isOfficial: false,
  ...
  {
    id: 'forum-cursor-discussions',
    name: 'Cursor Forum — Discussions',
    category: 'forum',
    feedUrl: 'https://forum.cursor.com/c/discussions/11.rss',
    ingestMethod: 'rss',
    enabled: true,
    priority: 18,
    isOfficial: false,
  ...
  {
    id: 'forum-cursor-ideas',
    name: 'Cursor Forum — Ideas',
    category: 'forum',
    feedUrl: 'https://forum.cursor.com/c/ideas/15.rss',
    ingestMethod: 'rss',
    enabled: true,
    priority: 19,
    isOfficial: false,
  ...
  {
    id: 'devto-cursor-ide',
    name: 'Dev.to — Cursor IDE',
    category: 'tutorial',
    feedUrl: 'https://dev.to/feed/tag/cursoride',
    ingestMethod: 'rss',
    enabled: true,
    priority: 28,
    isOfficial: false,
  ...
  {
    id: 'medium-cursor-ide',
    name: 'Medium — Cursor IDE',
    category: 'tutorial',
    feedUrl: 'https://medium.com/feed/tag/cursor-ide',
    ingestMethod: 'rss',
    enabled: true,
    priority: 31,
    isOfficial: false,
